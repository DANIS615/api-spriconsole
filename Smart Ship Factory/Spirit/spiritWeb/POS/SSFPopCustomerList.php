<?php
//Include Common Files @1-9A882029
define("RelativePath", "..");
define("PathToCurrentPage", "/POS/");
define("FileName", "SSFPopCustomerList.php");
...
//Class_Initialize Event @6-7E581D1C
...
//Operation Method @6-4DE32056
    function Operation()
    {
        ...
        $Redirect = "SSFPopCustomerList.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopCustomerList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "s_v_id", "s_v_description")), CCGetQueryString("QueryString", array("s_v_id", "ccsForm", "s_v_id", "s_v_description")));
...
//Class_Initialize Event @2-36692A7B
...
//DataSource Variables @2-2FA4CA39
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F8F6D4D5
...
//SetValues Method @2-2543DBD3
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("tkt_cust_id"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopCustomerList.html";
$BlockToParse = "main";
