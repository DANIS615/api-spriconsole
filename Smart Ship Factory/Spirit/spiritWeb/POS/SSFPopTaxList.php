<?php
//Include Common Files @1-5F062E6A
define("RelativePath", "..");
define("PathToCurrentPage", "/POS/");
define("FileName", "SSFPopTaxList.php");
...
//Class_Initialize Event @6-22787A49
...
//Operation Method @6-5BCABAD8
    function Operation()
    {
        ...
        $Redirect = "SSFPopTaxList.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopTaxList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @2-54E8917D
    function clsGridssf_std_store($RelativePath, & $Parent)
    {
        ...
        $this->tkt_tax_value = new clsControl(ccsLabel, "tkt_tax_value", "tkt_tax_value", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), CCGetRequestParam("tkt_tax_value", ccsGet, NULL), $this);
...
//DataSource Variables @2-6F9E9AD8
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-91507CE7
...
//Prepare Method @2-E97B5DCB
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "tkt_tax_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-EB74BA30
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM ssf_tkt_taxes";
        $this->SQL = "SELECT tkt_tax_id, tkt_tax_desc, tkt_tax_value \n\n" .
...
//SetValues Method @2-C4A1D71A
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("tkt_tax_id"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopTaxList.html";
$BlockToParse = "main";
