<?php
//Include Common Files @1-1BB36551
define("RelativePath", "..");
define("PathToCurrentPage", "/POS/");
define("FileName", "SSFTicketRobot.php");
...
//Class_Initialize Event @3-DE9D2D24
    function clsGridssf_tkt_catalog($RelativePath, & $Parent)
    {
        ...
        $this->tkt_catalog_code->Page = "SSFTicketRobot.php";
        ...
        $this->ssf_tkt_catalog_Insert->Page = "SSFTicketRobot.php";
...
//Prepare Method @3-93487A3C
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->Criterion[1] = "tkt_catalog_id = 'pos_robot_id'";
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
//Class_Initialize Event @16-8C085274
    function clsRecordssf_tkt_catalog1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->tkt_catalog_misc1 = new clsControl(ccsTextBox, "tkt_catalog_misc1", "tkt_catalog_misc1", ccsInteger, "", CCGetRequestParam("tkt_catalog_misc1", $Method, NULL), $this);
...
//CheckErrors Method @16-2FCB3A48
...
//Operation Method @16-45B9F1A3
    function Operation()
    {
        ...
        $Redirect = "SSFTicketRobot.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "SSFTicketRobot.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "tkt_catalog_code", "ssf_tkt_catalog_Insert", "tkt_config_param_id", "ssf_tkt_configuration_Insert"));
...
//DataSource Variables @16-B5FE48F0
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @16-0A1A443E
    function clsssf_tkt_catalog1DataSource(& $Parent)
    {
        ...
        $this->Initialize();
        $this->tkt_catalog_code = new clsField("tkt_catalog_code", ccsText, "");
        $this->tkt_catalog_misc1 = new clsField("tkt_catalog_misc1", ccsInteger, "");
        $this->tkt_catalog_value = new clsField("tkt_catalog_value", ccsText, "");
        ...
        $this->InsertFields["tkt_catalog_misc1"] = array("Name" => "tkt_catalog_misc1", "Value" => "", "DataType" => ccsInteger);
        ...
        $this->UpdateFields["tkt_catalog_misc1"] = array("Name" => "tkt_catalog_misc1", "Value" => "", "DataType" => ccsInteger);
...
//SetValues Method @16-C687C9E1
    function SetValues()
    {
        $this->tkt_catalog_code->SetDBValue($this->f("tkt_catalog_code"));
        $this->tkt_catalog_misc1->SetDBValue(trim($this->f("tkt_catalog_misc1")));
        $this->tkt_catalog_value->SetDBValue($this->f("tkt_catalog_value"));
        $this->tkt_catalog_id->SetDBValue($this->f("tkt_catalog_id"));
    }
//End SetValues Method

//Insert Method @16-983E296C
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Class_Initialize Event @35-6438E96E
    function clsGridssf_tkt_configuration($RelativePath, & $Parent)
    {
        ...
        $this->tkt_config_param_id->Page = "SSFTicketRobot.php";
        ...
        $this->ssf_tkt_configuration_Insert->Page = "SSFTicketRobot.php";
        $this->Navigator = new clsNavigator($this->ComponentName, "Navigator", $FileName, 10, tpCentered, $this);
    }
//End Class_Initialize Event
...
//Class_Initialize Event @48-14D06ABA
...
"FROM ssf_tkt_catalog {SQL_Where} {SQL_OrderBy}";
            ...
            $this->tkt_config_param_id->DataSource->wp->Criterion[1] = "tkt_catalog_id = 'pos_robot_config'";
...
//Operation Method @48-7C3F5E81
    function Operation()
    {
        ...
        $Redirect = "SSFTicketRobot.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "SSFTicketRobot.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "ssf_tkt_configuration_Insert", "tkt_config_param_id"));
            if(!CCGetEvent($this->Button_Delete->CCSEvents, "OnClick", $this->Button_Delete) || !$this->DeleteRow()) {
                $Redirect = "";
            }
        } else if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFTicketRobot.html";
$BlockToParse = "main";
...
//Include events file @1-FFAB8963
include("./SSFTicketRobot_events.php");
