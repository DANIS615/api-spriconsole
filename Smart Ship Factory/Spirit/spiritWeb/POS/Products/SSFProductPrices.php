<?php
//Include Common Files @1-09227A96
define("RelativePath", "../..");
define("PathToCurrentPage", "/POS/Products/");
define("FileName", "SSFProductPrices.php");
...
//Class_Initialize Event @5-4CD215D9
    function clsRecordssf_tkt_pricesSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClearParameters->Parameters = CCGetQueryString("QueryString", array("s_tkt_price_plu_id", "s_tkt_price_date", "ccsForm"));
            $this->ClearParameters->Page = "SSFProductPrices.php";
...
//Operation Method @5-65D42D87
    function Operation()
    {
        ...
        $Redirect = "SSFProductPrices.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFProductPrices.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @3-8040DE6C
    function clsGridssf_tkt_prices($RelativePath, & $Parent)
    {
        ...
        $this->tkt_price_plu_id->Page = "SSFProductPrices.php";
        ...
        $this->tkt_price_time = & new clsControl(ccsLabel, "tkt_price_time", "tkt_price_time", ccsDate, array("H", ":", "nn", ":", "ss"), CCGetRequestParam("tkt_price_time", ccsGet, NULL), $this);
        $this->tkt_price_price = & new clsControl(ccsLabel, "tkt_price_price", "tkt_price_price", ccsFloat, "", CCGetRequestParam("tkt_price_price", ccsGet, NULL), $this);
        ...
        $this->ssf_tkt_prices_Insert->Page = "SSFProductPrices.php";
...
//Show Method @3-B0AE4218
    function Show()
    {
        ...
        $this->DataSource->Parameters["urls_tkt_price_date"] = CCGetFromGet("s_tkt_price_date", NULL);
        ...
        if (!$this->IsEmpty) {
            ...
            do {
                ...
                $this->tkt_price_plu_id->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
...
//Prepare Method @3-24CA8211
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urls_tkt_price_date", ccsText, "", "", $this->Parameters["urls_tkt_price_date"], "", false);
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "tkt_price_date", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
...
//Class_Initialize Event @27-EEC3CD2F
    function clsRecordssf_tkt_prices1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->tkt_price_date = & new clsControl(ccsTextBox, "tkt_price_date", $CCSLocales->GetText("tkt_price_date"), ccsDate, array("dd", "/", "mm", "/", "yyyy"), CCGetRequestParam("tkt_price_date", $Method, NULL), $this);
            ...
            $this->tkt_price_time = & new clsControl(ccsTextBox, "tkt_price_time", $CCSLocales->GetText("tkt_price_time"), ccsDate, array("H", ":", "nn", ":", "ss"), CCGetRequestParam("tkt_price_time", $Method, NULL), $this);
            $this->tkt_price_time->Required = true;
            $this->tkt_price_price = & new clsControl(ccsTextBox, "tkt_price_price", $CCSLocales->GetText("tkt_price_price"), ccsFloat, array(False, 3, Null, "", False, "", "", 1, True, ""), CCGetRequestParam("tkt_price_price", $Method, NULL), $this);
...
//CheckErrors Method @27-1E27BDB4
    function CheckErrors()
    {
        $errors = false;
...
//Operation Method @27-3F2500B6
    function Operation()
    {
        ...
        $Redirect = "SSFProductPrices.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//DataSource Variables @27-9514BB13
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @27-0D78B657
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFProductPrices.html";
$BlockToParse = "main";
$TemplateEncoding = "CP1252";
$PathToRoot = "../../";
//End Initialize Page

//Initialize Objects @1-DC30F0EA
