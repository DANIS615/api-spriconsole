<?php
//Include Common Files @1-D70187C1
define("RelativePath", "../..");
define("PathToCurrentPage", "/POS/Reports/");
define("FileName", "SSFTicketTrxbyProd.php");
...
//Class_Initialize Event @67-5024CFE8
...
"FROM ssf_tkt_categories {SQL_Where} {SQL_OrderBy}";
            ...
            $this->rboption->Values = array(array("0", $CCSLocales->GetText("ssf_pump_sales_by_grade")), array("1", $CCSLocales->GetText("ssf_salesbydate")));
            $this->rboption->HTML = true;
            $this->Link1 = new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", $Method, NULL), $this);
            $this->Link1->Page = "SSFTicketTrxbyProd.php";
...
//Operation Method @67-4C7027AC
    function Operation()
    {
        ...
        $Redirect = "SSFTicketTrxbyProd.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFTicketTrxbyProd.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Open Method @132-C82DA984
    function Open()
    {
        ...
        "h.tkt_date, h.tkt_receipt_type, h.tkt_receipt_group, h.tkt_receipt_number \n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFTicketTrxbyProd.html";
$BlockToParse = "main";
...
//Include events file @1-8131145F
include("./SSFTicketTrxbyProd_events.php");
...
//Go to destination page @1-E3FC5423
if($Redirect)
{
