...
function BindEvents()
{
    ...
    $ssf_tkt_customers_tags1->customerlnk->CCSEvents["BeforeShow"] = "ssf_tkt_customers_tags1_customerlnk_BeforeShow";
...
//ssf_tkt_customers_tags1_customerlnk_BeforeShow @31-026E2E97
function ssf_tkt_customers_tags1_customerlnk_BeforeShow(& $sender)
{
    $ssf_tkt_customers_tags1_customerlnk_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $ssf_tkt_customers_tags1; //Compatibility
//End ssf_tkt_customers_tags1_customerlnk_BeforeShow
...
//Close ssf_tkt_customers_tags1_customerlnk_BeforeShow @31-81FD9817
    return $ssf_tkt_customers_tags1_customerlnk_BeforeShow;
}
//End Close ssf_tkt_customers_tags1_customerlnk_BeforeShow
...
//Page_AfterInitialize @1-AAB2F8AC
function Page_AfterInitialize(& $sender)
{
    $Page_AfterInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $SSFTicketCustomersTag; //Compatibility
...
//Custom Code @32-2A29BDB7
	...
	$EditisAllowed = $accmgr->CheckUserAction("WEB_TKT_CUS_TAG_EDIT") ;
	$ViewisAllowed = $accmgr->CheckUserAction("WEB_TKT_CUS_TAG_VIEW") ;
