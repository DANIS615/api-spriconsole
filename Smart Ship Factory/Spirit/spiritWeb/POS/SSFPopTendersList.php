<?php
//Include Common Files @1-A92770DF
define("RelativePath", "..");
define("PathToCurrentPage", "/POS/");
define("FileName", "SSFPopTendersList.php");
...
//Class_Initialize Event @6-A6D41388
    function clsRecordssf_std_storeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Link1->Page = "SSFPopTendersList.php";
...
//Operation Method @6-6436347C
    function Operation()
    {
        ...
        $Redirect = "SSFPopTendersList.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopTendersList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "s_v_id", "s_v_description")), CCGetQueryString("QueryString", array("s_v_id", "ccsForm", "s_v_id", "s_v_description")));
...
//SetOrder Method @2-1FBA3E5A
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "tkt_tender_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_v_id" => array("tkt_tender_id", ""), 
            "Sorter_prod_id" => array("tkt_tender_desc", "")));
    }
//End SetOrder Method

//Prepare Method @2-1FC7B54E
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Open Method @2-08A51257
    function Open()
    {
        ...
        $this->SQL = "SELECT tkt_catalog_value AS tender_type, tkt_tender_id, tkt_tender_desc \n\n" .
        "FROM ssf_tkt_tender INNER JOIN ssf_tkt_catalog ON\n\n" .
...
//SetValues Method @2-DDC82398
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("tkt_tender_id"));
        $this->prod_desc->SetDBValue($this->f("tkt_tender_desc"));
        $this->prod_type->SetDBValue($this->f("tender_type"));
    }
//End SetValues Method

} //End ssf_std_storeDataSource Class @2-FCB6E20C

//Initialize Page @1-F9A4512B
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopTendersList.html";
$BlockToParse = "main";
