...
//Show Page @1-CADF1273
$Login->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
$main_block = $Tpl->GetVar($BlockToParse);
$KOHLPG3J8R6L1L8G = "<center><font face=\"Arial\"><small>&#71;&#101;&#110;er&#97;&#116;e&#100; <!-- CCS -->w&#105;&#116;h <!-- CCS -->&#67;ode&#67;&#104;&#97;&#114;ge <!-- CCS -->St&#117;d&#105;&#111;.</small></font></center>";
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", $KOHLPG3J8R6L1L8G . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", $KOHLPG3J8R6L1L8G . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= $KOHLPG3J8R6L1L8G;
}
