<?php
//Include Common Files @1-CC67B503
define("RelativePath", "..");
...
//Include Page implementation @33-698CFA3F
...
//Class_Initialize Event @3-18A234FA
    function clsEditableGridEditableGrid1($RelativePath, & $Parent)
    {
        ...
        $this->Button_stop_fuel_charge = new clsButton("Button_stop_fuel_charge", $Method, $this);
...
//Operation Method @3-D5A25C94
    function Operation()
    {
        ...
        if($this->Button_end_tank_charge->Pressed) {
            $this->PressedButton = "Button_end_tank_charge";
        } else if($this->Button_stop_fuel_charge->Pressed) {
            $this->PressedButton = "Button_stop_fuel_charge";
        ...
        } else if($this->PressedButton == "Button_stop_fuel_charge") {
            if(!CCGetEvent($this->Button_stop_fuel_charge->CCSEvents, "OnClick", $this->Button_stop_fuel_charge) || !$this->UpdateGrid()) {
                $Redirect = "";
            }
        } else if($this->PressedButton == "Cancel") {
            if(!CCGetEvent($this->Cancel->CCSEvents, "OnClick", $this->Cancel) || !$this->UpdateGrid()) {
                $Redirect = "";
            }
        } else {
            $Redirect = "";
...
//Show Method @3-11F83E66
    function Show()
    {
        ...
        $this->Button_stop_fuel_charge->Visible = $this->Button_stop_fuel_charge->Visible && ($this->InsertAllowed || $this->UpdateAllowed || $this->DeleteAllowed);
        $this->Cancel->Visible = $this->Cancel->Visible && ($this->InsertAllowed || $this->UpdateAllowed || $this->DeleteAllowed);
        ...
        $this->Button_stop_fuel_charge->Show();
        $this->Cancel->Show();
