<?php
//Include Common Files @1-57DE7A5A
define("RelativePath", "../..");
define("PathToCurrentPage", "/Operation/Convol/");
define("FileName", "SSFImportPublicKey.php");
...
class clsRecordNewRecord1 { //NewRecord1 Class @4-D7EDAFB1
...
//Class_Initialize Event @4-D4B4F32F
    function clsRecordNewRecord1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->FileUpload1 = new clsFileUpload("FileUpload1", $CCSLocales->GetText("ssf_file_to_import"), "../../data/", "../../data/convol/", "mastersconf.zip", "", 100000, $this);
...
} //End NewRecord1 Class @4-FCB6E20C

//Initialize Page @1-A430B403
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFImportPublicKey.html";
$BlockToParse = "main";
...
//Include events file @1-A2BD6CD1
include("./SSFImportPublicKey_events.php");
