<?php
//Include Common Files @1-FF5EEC69
define("RelativePath", "..");
define("PathToCurrentPage", "/Fleet/");
define("FileName", "SSFPopFleetModelList.php");
...
//Class_Initialize Event @6-F1D3B94F
...
//Operation Method @6-E3171E98
    function Operation()
    {
        ...
        $Redirect = "SSFPopFleetModelList.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopFleetModelList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//SetOrder Method @2-A2AF643C
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "pm_model_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_v_id" => array("pm_model_id", "")));
    }
//End SetOrder Method

//Prepare Method @2-664ED0D4
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Open Method @2-71139041
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM ssf_flt_profile_model";
        $this->SQL = "SELECT pm_model_id \n\n" .
...
//SetValues Method @2-35011FA7
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("pm_model_id"));
    }
//End SetValues Method

} //End ssf_std_storeDataSource Class @2-FCB6E20C

//Initialize Page @1-E6D173A0
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopFleetModelList.html";
$BlockToParse = "main";
