<?php
//Include Common Files @1-9D554EAA
define("RelativePath", "..");
define("PathToCurrentPage", "/Fleet/");
define("FileName", "SSFPopTimeProfList.php");
...
//Class_Initialize Event @6-A0431228
    function clsRecordssf_std_storeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Link1->Page = "SSFPopTimeProfList.php";
...
//Operation Method @6-BBF2D4BF
    function Operation()
    {
        ...
        $Redirect = "SSFPopTimeProfList.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopTimeProfList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//SetOrder Method @2-F63B976A
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "tp_profile_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_v_id" => array("tp_profile_id", "")));
    }
//End SetOrder Method

//Prepare Method @2-40CDBBA5
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//SetValues Method @2-171AFACC
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("tp_profile_id"));
    }
//End SetValues Method

} //End ssf_std_storeDataSource Class @2-FCB6E20C

//Initialize Page @1-494354DE
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopTimeProfList.html";
$BlockToParse = "main";
