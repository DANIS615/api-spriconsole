<?php
//Include Common Files @1-3CE7BA81
define("RelativePath", "..");
define("PathToCurrentPage", "/Fleet/");
define("FileName", "SSFPopLimitProfList.php");
...
//Class_Initialize Event @6-BDB7C4AF
    function clsRecordssf_std_storeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Link1->Page = "SSFPopLimitProfList.php";
...
//Operation Method @6-EFE33433
    function Operation()
    {
        ...
        $Redirect = "SSFPopLimitProfList.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopLimitProfList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//SetOrder Method @2-DFB7FC64
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "lp_profile_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_v_id" => array("lp_profile_id", "")));
    }
//End SetOrder Method

//Prepare Method @2-23457516
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Open Method @2-D0A1BD89
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(DISTINCT( lp_profile_id)) \n\n" .
        "FROM ssf_flt_limit_profile";
        $this->SQL = "SELECT lp_profile_id \n\n" .
        "FROM ssf_flt_limit_profile {SQL_Where}\n\n" .
        "GROUP BY lp_profile_id {SQL_OrderBy}";
...
//SetValues Method @2-2EE808D8
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("lp_profile_id"));
    }
//End SetValues Method

} //End ssf_std_storeDataSource Class @2-FCB6E20C

//Initialize Page @1-5C1E1A4C
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopLimitProfList.html";
$BlockToParse = "main";
