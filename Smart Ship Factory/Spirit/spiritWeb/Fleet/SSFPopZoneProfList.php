<?php
//Include Common Files @1-DF21D574
define("RelativePath", "..");
define("PathToCurrentPage", "/Fleet/");
define("FileName", "SSFPopZoneProfList.php");
...
//Class_Initialize Event @6-B222ED51
    function clsRecordssf_std_storeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Link1->Page = "SSFPopZoneProfList.php";
...
//Operation Method @6-4C203317
    function Operation()
    {
        ...
        $Redirect = "SSFPopZoneProfList.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopZoneProfList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @2-F3F1EE15
...
//DataSource Variables @2-8D1CFDFA
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-0428F7E7
...
//SetOrder Method @2-09642873
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "zp_profile_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_v_id" => array("zp_profile_id", "")));
    }
//End SetOrder Method

//Prepare Method @2-E2330F28
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urls_v_id", ccsText, "", "", $this->Parameters["urls_v_id"], "", false);
...
//SetValues Method @2-0E37E845
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("zp_profile_id"));
    }
//End SetValues Method

} //End ssf_std_storeDataSource Class @2-FCB6E20C

//Initialize Page @1-21B1C231
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopZoneProfList.html";
$BlockToParse = "main";
