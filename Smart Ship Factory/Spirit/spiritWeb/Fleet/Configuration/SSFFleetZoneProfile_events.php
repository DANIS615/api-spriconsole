...
global $CCSLocales ;
$Component->SetText($CCSLocales->GetText("ssf_station_name")) ;
...
//DEL  if (CCGetParam("pp_profile_id") != "") 
...
//Custom Code @76-2A29BDB7
	...
	$where = " pm_zone_prof_id = '".$ssf_flt_product_profile1->pp_profile_id->GetValue()."' " ;
...
//Page_AfterInitialize @1-BAE3EBDA
function Page_AfterInitialize(& $sender)
{
    $Page_AfterInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $SSFFleetZoneProfile; //Compatibility
...
//Custom Code @26-2A29BDB7
	...
	$EditisAllowed = $accmgr->CheckUserAction("WEB_FLT_ZOPRO_EDIT") ;
	$ViewisAllowed = $accmgr->CheckUserAction("WEB_FLT_ZOPRO_VIEW") ;
