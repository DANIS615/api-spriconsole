<?php
//Include Common Files @1-E9DE2FF1
define("RelativePath", "..");
define("PathToCurrentPage", "/Fleet/");
define("FileName", "SSFPopProdProfList.php");
...
//Class_Initialize Event @6-A609EEFD
...
//Operation Method @6-D43F68C0
    function Operation()
    {
        ...
        $Redirect = "SSFPopProdProfList.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopProdProfList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//SetOrder Method @2-FA798417
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "pp_profile_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_v_id" => array("pp_profile_id", "")));
    }
//End SetOrder Method

//Prepare Method @2-BDC91A4D
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//SetValues Method @2-1CB22DCA
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("pp_profile_id"));
    }
//End SetValues Method

} //End ssf_std_storeDataSource Class @2-FCB6E20C

//Initialize Page @1-513D9CBE
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopProdProfList.html";
$BlockToParse = "main";
