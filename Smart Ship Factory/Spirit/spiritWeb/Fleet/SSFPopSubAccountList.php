<?php
//Include Common Files @1-CCB57EC1
define("RelativePath", "..");
define("PathToCurrentPage", "/Fleet/");
define("FileName", "SSFPopSubAccountList.php");
...
//Class_Initialize Event @6-38261CD1
    function clsRecordssf_std_storeSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Link1->Page = "SSFPopSubAccountList.php";
...
//Operation Method @6-7BFA78EE
    function Operation()
    {
        ...
        $Redirect = "SSFPopSubAccountList.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPopSubAccountList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_v_id", "ccsForm")));
...
//Show Method @2-A05F1E82
    function Show()
    {
        ...
        $this->DataSource->Parameters["urlcust_id"] = CCGetFromGet("cust_id", NULL);
...
//SetOrder Method @2-7FB176E2
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "fcs_subaccnt_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_v_id" => array("fcs_subaccnt_id", ""), 
            "Sorter_prod_id" => array("fcs_subaccnt_description", "")));
    }
//End SetOrder Method

//Prepare Method @2-9FB6793F
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlcust_id", ccsText, "", "", $this->Parameters["urlcust_id"], "", false);
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "fcs_subaccnt_id", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
...
//Open Method @2-03036494
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM ssf_flt_customers_subaccounts";
        $this->SQL = "SELECT fcs_subaccnt_id, fcs_subaccnt_description, fcs_subaccnt_car_id \n\n" .
...
//SetValues Method @2-99A97D92
    function SetValues()
    {
        $this->v_id->SetDBValue($this->f("fcs_subaccnt_id"));
        $this->prod_desc->SetDBValue($this->f("fcs_subaccnt_description"));
        $this->prod_type->SetDBValue($this->f("fcs_subaccnt_car_id"));
    }
//End SetValues Method

} //End ssf_std_storeDataSource Class @2-FCB6E20C

//Initialize Page @1-7FD6EF59
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPopSubAccountList.html";
$BlockToParse = "main";
