...
//Include Files @0-8E089DC4
include(RelativePath . "/Classes.php");
include(RelativePath . "/db_mssql.php");
//End Include Files

//Connection Settings @0-9706D8D8
...
//Initialize Common Variables @0-A0FEE226
...
//Connection1 Connection Class @-9408888D
class clsDBConnection1 extends DB_MSSQL
{
    ...
    function OptimizeSQL($SQL)
    {
        ...
        if (strcmp($this->RecordsCount, "CCS not counted")) 
            $SQL = preg_replace("/\s\{SqlParam_endRecord\}\s/" , " " . ($Page  * $PageSize) . " ", $SQL);
        else
            $SQL = preg_replace("/\s\{SqlParam_endRecord\}\s/" , " " . ($Page  * $PageSize + 1) . " ", $SQL);
        return $SQL;
    }
