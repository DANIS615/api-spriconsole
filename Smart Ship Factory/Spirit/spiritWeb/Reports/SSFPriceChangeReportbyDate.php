<?php
//Include Common Files @1-FC02FF7C
define("RelativePath", "..");
define("PathToCurrentPage", "/Reports/");
define("FileName", "SSFPriceChangeReportbyDate.php");
...
//Class_Initialize Event @15-EF55140B
    function clsRecorda_bSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->s_price_level->DSType = dsTable;
            list($this->s_price_level->BoundColumn, $this->s_price_level->TextColumn, $this->s_price_level->DBFormat) = array("level", "level", "");
            $this->s_price_level->DataSource = new clsDBConnection1();
            $this->s_price_level->ds = & $this->s_price_level->DataSource;
            $this->s_price_level->DataSource->SQL = "SELECT \"level\" \n" .
"FROM ssf_grade_prices {SQL_Where}\n" .
"GROUP BY \"level\" {SQL_OrderBy}";
            $this->Link1 = new clsControl(ccsLink, "Link1", "Link1", ccsText, "", CCGetRequestParam("Link1", $Method, NULL), $this);
            $this->Link1->Page = "SSFPriceChangeReportbyDate.php";
...
//Operation Method @15-D1C7BACE
    function Operation()
    {
        ...
        $Redirect = "SSFPriceChangeReportbyDate.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFPriceChangeReportbyDate.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//ssf_addin_prices_change_a ReportGroup class @2-D9BF30A2
class clsReportGroupssf_addin_prices_change_a {
    ...
    public $application_date1, $_application_date1Attributes;
    ...
    public $RowNumber;
    public $Parent;
    public $application_dateTotalIndex;
    ...
    function SetControls($PrevGroup = "") {
        ...
        $this->application_date1 = $this->Parent->application_date1->Value;
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_application_date1Attributes = $this->Parent->application_date1->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->application_date1 = $Header->application_date1;
        $Header->_application_date1Attributes = $this->_application_date1Attributes;
        $this->Parent->application_date1->Value = $Header->application_date1;
        $this->Parent->application_date1->Attributes->RestoreFromArray($Header->_application_date1Attributes);
...
//ssf_addin_prices_change_a GroupsCollection class @2-69AF46C2
class clsGroupsCollectionssf_addin_prices_change_a {
    public $Groups;
    public $mPageCurrentHeaderIndex;
    public $mapplication_dateCurrentHeaderIndex;
    public $PageSize;
    public $TotalPages = 0;
    public $TotalRows = 0;
    ...
    function clsGroupsCollectionssf_addin_prices_change_a(& $parent) {
        ...
        $this->Groups = array();
        $this->Pages  = array();
        $this->mapplication_dateCurrentHeaderIndex = 1;
    ...
    function & InitGroup() {
        ...
        $group->application_dateTotalIndex = $this->mapplication_dateCurrentHeaderIndex;
        return $group;
    }
    ...
    function RestoreValues() {
        ...
        $this->Parent->application_date1->Value = $this->Parent->application_date1->initialValue;
    ...
    function OpenGroup($groupName) {
        ...
        if ($groupName == "application_date") {
            $Groupapplication_date = & $this->InitGroup(true);
            $this->Parent->application_date_Header->CCSEventResult = CCGetEvent($this->Parent->application_date_Header->CCSEvents, "OnInitialize", $this->Parent->application_date_Header);
            if ($this->Parent->Page_Footer->Visible) 
                $OverSize = $this->Parent->application_date_Header->Height + $this->Parent->Page_Footer->Height;
            else
                $OverSize = $this->Parent->application_date_Header->Height;
            if (($this->PageSize > 0) and $this->Parent->application_date_Header->Visible and ($this->CurrentPageSize + $OverSize > $this->PageSize)) {
                $this->ClosePage();
                $this->OpenPage();
            }
            if ($this->Parent->application_date_Header->Visible)
                $this->CurrentPageSize = $this->CurrentPageSize + $this->Parent->application_date_Header->Height;
                $Groupapplication_date->SetTotalControls("GetNextValue");
            $this->Parent->application_date_Header->CCSEventResult = CCGetEvent($this->Parent->application_date_Header->CCSEvents, "OnCalculate", $this->Parent->application_date_Header);
            $Groupapplication_date->SetControls();
            $Groupapplication_date->Mode = 1;
            $Groupapplication_date->GroupType = "application_date";
            $this->mapplication_dateCurrentHeaderIndex = count($this->Groups);
            $this->Groups[] = & $Groupapplication_date;
        }
    }
    ...
    function CloseGroup($groupName)
    {
        ...
        $Groupapplication_date = & $this->InitGroup(true);
        $this->Parent->application_date_Footer->CCSEventResult = CCGetEvent($this->Parent->application_date_Footer->CCSEvents, "OnInitialize", $this->Parent->application_date_Footer);
        if ($this->Parent->Page_Footer->Visible) 
            $OverSize = $this->Parent->application_date_Footer->Height + $this->Parent->Page_Footer->Height;
        else
            $OverSize = $this->Parent->application_date_Footer->Height;
        if (($this->PageSize > 0) and $this->Parent->application_date_Footer->Visible and ($this->CurrentPageSize + $OverSize > $this->PageSize)) {
            $this->ClosePage();
            $this->OpenPage();
        }
        $Groupapplication_date->SetTotalControls("GetPrevValue");
        $Groupapplication_date->SyncWithHeader($this->Groups[$this->mapplication_dateCurrentHeaderIndex]);
        if ($this->Parent->application_date_Footer->Visible)
            $this->CurrentPageSize = $this->CurrentPageSize + $this->Parent->application_date_Footer->Height;
        $this->Parent->application_date_Footer->CCSEventResult = CCGetEvent($this->Parent->application_date_Footer->CCSEvents, "OnCalculate", $this->Parent->application_date_Footer);
        $Groupapplication_date->SetControls();
        $this->RestoreValues();
        $Groupapplication_date->Mode = 2;
        $Groupapplication_date->GroupType ="application_date";
        $this->Groups[] = & $Groupapplication_date;
    }
...
//ssf_addin_prices_change_a Variables @2-7BEDFBC1
    ...
    public $application_date_HeaderBlock, $application_date_Header;
    public $application_date_FooterBlock, $application_date_Footer;
    ...
    public $application_date_HeaderControls, $application_date_FooterControls;
...
//Class_Initialize Event @2-372F95B2
    function clsReportssf_addin_prices_change_a($RelativePath = "", & $Parent)
    {
        ...
        $this->application_date_Footer = new clsSection($this);
        $this->application_date_Footer->Height = 1;
        $MaxSectionSize = max($MaxSectionSize, $this->application_date_Footer->Height);
        $this->application_date_Header = new clsSection($this);
        $this->application_date_Header->Height = 1;
        $MaxSectionSize = max($MaxSectionSize, $this->application_date_Header->Height);
        $this->Errors = new clsErrors();
        ...
        $this->application_date1 = new clsControl(ccsReportLabel, "application_date1", "application_date1", ccsText, "", "", $this);
...
//CheckErrors Method @2-D743682D
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->application_date1->Errors->Count());
...
//GetErrors Method @2-F79424CA
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->application_date1->Errors->ToString());
...
//Show Method @2-EE624A7A
    function Show()
    {
        ...
        while($is_next_record) {
            ...
            $this->application_date1->SetValue($this->DataSource->application_date1->GetValue());
            ...
            if (count($Groups->Groups) == 2 or $application_dateKey != $this->DataSource->f("application_date")) {
                $Groups->OpenGroup("application_date");
            }
            $Groups->AddItem();
            $application_dateKey = $this->DataSource->f("application_date");
            $is_next_record = $this->DataSource->next_record();
            if (!$is_next_record || $application_dateKey != $this->DataSource->f("application_date")) {
                $Groups->CloseGroup("application_date");
            }
        }
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["application_date1"] = $this->application_date1->Visible;
            ...
            do {
                ...
                switch ($items[$i]->GroupType) {
                    ...
                    case "application_date":
                        if ($items[$i]->Mode == 1) {
                            $this->application_date1->SetValue($items[$i]->application_date1);
                            $this->application_date1->Attributes->RestoreFromArray($items[$i]->_application_date1Attributes);
                            $this->application_date_Header->CCSEventResult = CCGetEvent($this->application_date_Header->CCSEvents, "BeforeShow", $this->application_date_Header);
                            if ($this->application_date_Header->Visible) {
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock . "/Section application_date_Header";
                                $this->Attributes->Show();
                                $this->application_date1->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
                                $Tpl->parseto("Section application_date_Header", true, "Section Detail");
                            }
                        }
                        if ($items[$i]->Mode == 2) {
                            $this->application_date_Footer->CCSEventResult = CCGetEvent($this->application_date_Footer->CCSEvents, "BeforeShow", $this->application_date_Footer);
                            if ($this->application_date_Footer->Visible) {
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock . "/Section application_date_Footer";
                                $this->Attributes->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
                                $Tpl->parseto("Section application_date_Footer", true, "Section Detail");
                            }
                        }
                        break;
                }
...
//DataSource Variables @2-39FDAAA4
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-3D2DA42F
    function clsssf_addin_prices_change_aDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Report ssf_addin_prices_change_a";
        $this->Initialize();
        $this->application_date1 = new clsField("application_date1", ccsText, "");
...
//SetOrder Method @2-E06659E3
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "b.grade_id desc, b.price_level desc";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_application_date" => array("application_date", ""), 
            "Sorter_application_time" => array("application_time", ""), 
            "Sorter_price_change_id" => array("a.price_change_id", ""), 
...
//Open Method @2-5F61CF24
    function Open()
    {
        ...
        $this->query(CCBuildSQL($this->SQL, $this->Where, "a.application_date desc" .  ($this->Order ? ", " . $this->Order: "")));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
    }
//End Open Method

//SetValues Method @2-AD85F757
    function SetValues()
    {
        $this->application_date1->SetDBValue($this->f("application_date"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFPriceChangeReportbyDate.html";
$BlockToParse = "main";
...
//Include events file @1-E446C2EB
include("./SSFPriceChangeReportbyDate_events.php");
