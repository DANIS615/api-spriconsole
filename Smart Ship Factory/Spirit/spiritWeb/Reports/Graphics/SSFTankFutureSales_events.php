...
global $CCSLocales ;
$Component->SetValue($CCSLocales->GetText("ssf_product_sales_forecast")) ;
//End Custom Code
...
//Page_BeforeShow @1-7FE46B2E
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $SSFTankFutureSales; //Compatibility
//End Page_BeforeShow

//Custom Code @17-2A29BDB7
global $Tpl ;
	$Tpl->setvar("phpdata", "SSFTankFutureSalesData.php?s_date_to=".CCGetParam("s_date_to")."&s_date_from=".CCGetParam("s_date_from")."&s_tank_id=".CCGetParam("s_tank_id")."&s_scale_option=".CCGetParam("s_scale_option",1)."&s_periods_ahead=".CCGetParam("s_periods_ahead",1)) ;
//End Custom Code
...
//Page_AfterInitialize @1-0D25EE07
