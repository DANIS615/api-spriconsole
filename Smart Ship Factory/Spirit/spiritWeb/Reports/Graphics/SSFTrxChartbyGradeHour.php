<?php
//Include Common Files @1-CA27F5DE
define("RelativePath", "../..");
define("PathToCurrentPage", "/Reports/Graphics/");
define("FileName", "SSFTrxChartbyGradeHour.php");
...
//Class_Initialize Event @3-5313C89C
    function clsRecordssf_pump_salesSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Link1->Page = "SSFTrxChartbyGradeHour.php";
...
//Operation Method @3-ABECC0B2
    function Operation()
    {
        ...
        $Redirect = "SSFTrxChartbyGradeHour.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFTrxChartbyGradeHour.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFTrxChartbyGradeHour.html";
$BlockToParse = "main";
...
//Include events file @1-566A81A1
include("./SSFTrxChartbyGradeHour_events.php");
