<?php
//Include Common Files @1-FC38AD0B
define("RelativePath", "../..");
define("PathToCurrentPage", "/Reports/Graphics/");
define("FileName", "SSFTankFutureSales.php");
...
//Class_Initialize Event @3-4E90BE5F
    function clsRecordssf_pump_salesSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            "where library = 'product' and groupname = 'general'\n" .
            ...
            $this->s_periods_ahead->Values = array(array("1", "1"), array("2", "2"), array("3", "3"), array("4", "4"), array("5", "5"), array("6", "6"), array("7", "7"), array("8", "8"), array("9", "9"), array("10", "10"), array("15", "15"));
            ...
            $this->Link1->Page = "SSFTankFutureSales.php";
...
//Operation Method @3-8847C820
    function Operation()
    {
        ...
        $Redirect = "SSFTankFutureSales.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFTankFutureSales.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFTankFutureSales.html";
$BlockToParse = "main";
...
//Include events file @1-B8FA2FEA
include("./SSFTankFutureSales_events.php");
