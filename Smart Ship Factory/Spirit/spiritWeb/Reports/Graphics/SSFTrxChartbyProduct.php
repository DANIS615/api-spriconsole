<?php
//Include Common Files @1-A69E904F
define("RelativePath", "../..");
define("PathToCurrentPage", "/Reports/Graphics/");
define("FileName", "SSFTrxChartbyProduct.php");
...
//Class_Initialize Event @3-71F15570
    function clsRecordssf_pump_salesSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->s_time_from = new clsControl(ccsTextBox, "s_time_from", "s_time_from", ccsDate, array("HH", ":", "nn", ":", "ss"), CCGetRequestParam("s_time_from", $Method, NULL), $this);
            $this->s_time_to = new clsControl(ccsTextBox, "s_time_to", "s_time_to", ccsDate, array("HH", ":", "nn", ":", "ss"), CCGetRequestParam("s_time_to", $Method, NULL), $this);
            ...
            $this->btnUintOption->Values = array(array("1", $CCSLocales->GetText("ssf_by_volume")), array("2", $CCSLocales->GetText("ssf_by_amount")));
            ...
            $this->Link1->Page = "SSFTrxChartbyProduct.php";
...
//Operation Method @3-6C718BE8
    function Operation()
    {
        ...
        $Redirect = "SSFTrxChartbyProduct.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFTrxChartbyProduct.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFTrxChartbyProduct.html";
$BlockToParse = "main";
...
//Include events file @1-1F38BD88
include("./SSFTrxChartbyProduct_events.php");
