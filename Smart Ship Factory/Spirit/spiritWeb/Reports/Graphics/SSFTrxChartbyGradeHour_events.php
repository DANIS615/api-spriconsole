...
//Close Label1_BeforeShow @20-B48DF954
...
//Page_BeforeShow @1-8A23C1F5
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $SSFTrxChartbyGradeHour; //Compatibility
//End Page_BeforeShow

//Custom Code @17-2A29BDB7
global $Tpl ;
	$Tpl->setvar("phpdata", "SSFTrxChartbyGradeHourData.php?s_date_to=".CCGetParam("s_date_to")."&s_date_from=".CCGetParam("s_date_from")."&s_grade_id=".CCGetParam("s_grade_id")."&s_unit_option=".CCGetParam("btnUintOption",1)."&s_rep_option=".CCGetParam("s_rep_option",1)."&s_scale_option=".CCGetParam("s_scale_option",2) ) ;
//End Custom Code
...
//Page_AfterInitialize @1-DC0D0E35
