<?php
//Include Common Files @1-867EA7C2
define("RelativePath", "../..");
define("PathToCurrentPage", "/Reports/Graphics/");
define("FileName", "SSFTankDeepReadingDiff.php");
...
//Class_Initialize Event @3-AE05BD74
    function clsRecordssf_pump_salesSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Link1->Page = "SSFTankDeepReadingDiff.php";
            $this->Button_DoSearch = new clsButton("Button_DoSearch", $Method, $this);
        }
    }
//End Class_Initialize Event

//Validate Method @3-B14E4152
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//Operation Method @3-5733140A
    function Operation()
    {
        ...
        $Redirect = "SSFTankDeepReadingDiff.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SSFTankDeepReadingDiff.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SSFTankDeepReadingDiff.html";
$BlockToParse = "main";
...
//Include events file @1-B80381F3
include("./SSFTankDeepReadingDiff_events.php");
