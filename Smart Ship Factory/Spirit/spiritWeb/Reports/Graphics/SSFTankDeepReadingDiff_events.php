...
//Page_BeforeShow @1-02AE104A
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $SSFTankDeepReadingDiff; //Compatibility
//End Page_BeforeShow

//Custom Code @17-2A29BDB7
global $Tpl ;
	$Tpl->setvar("phpdata", "SSFTankDeepReadingDiffData.php?s_date_to=".CCGetParam("s_date_to")."&s_date_from=".CCGetParam("s_date_from")."&s_tank_id=".CCGetParam("s_tank_id") ) ;
//End Custom Code
...
//Page_AfterInitialize @1-5480DF8A
