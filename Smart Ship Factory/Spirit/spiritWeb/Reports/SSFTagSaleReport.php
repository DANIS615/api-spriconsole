<?php
//Include Common Files @1-2D20EE60
define("RelativePath", "..");
...
//Class_Initialize Event @18-DF5294D3
...
//CheckErrors Method @18-75F0D219
...
//ssf_addin_tags_sale_data1 ReportGroup class @3-E9DA2DF5
class clsReportGroupssf_addin_tags_sale_data1 {
    ...
    public $tag_sale_info, $_tag_sale_infoAttributes;
    ...
    function SetControls($PrevGroup = "") {
        ...
        $this->tag_sale_info = $this->Parent->tag_sale_info->Value;
    }
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_Sorter_tag_sale_infoAttributes = $this->Parent->Sorter_tag_sale_info->Attributes->GetAsArray();
        ...
        $this->_tag_sale_infoAttributes = $this->Parent->tag_sale_info->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->tag_sale_info = $Header->tag_sale_info;
        $Header->_tag_sale_infoAttributes = $this->_tag_sale_infoAttributes;
        $this->Parent->tag_sale_info->Value = $Header->tag_sale_info;
        $this->Parent->tag_sale_info->Attributes->RestoreFromArray($Header->_tag_sale_infoAttributes);
    }
...
//ssf_addin_tags_sale_data1 GroupsCollection class @3-B458CA2F
class clsGroupsCollectionssf_addin_tags_sale_data1 {
    ...
    function RestoreValues() {
        ...
        $this->Parent->tag_sale_info->Value = $this->Parent->tag_sale_info->initialValue;
...
//ssf_addin_tags_sale_data1 Variables @3-A5F68A6C
    ...
    public $Sorter_money;
    public $Sorter_tag_sale_info;
//End ssf_addin_tags_sale_data1 Variables

//Class_Initialize Event @3-BFF06E15
    function clsReportssf_addin_tags_sale_data1($RelativePath = "", & $Parent)
    {
        ...
        $this->Sorter_tag_sale_info = new clsSorter($this->ComponentName, "Sorter_tag_sale_info", $FileName, $this);
        ...
        $this->tag_sale_info = new clsControl(ccsReportLabel, "tag_sale_info", "tag_sale_info", ccsText, "", "", $this);
...
//CheckErrors Method @3-18B358E7
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->tag_sale_info->Errors->Count());
...
//GetErrors Method @3-D69BBE37
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->tag_sale_info->Errors->ToString());
...
//Show Method @3-31F7A98D
    function Show()
    {
        ...
        while($is_next_record) {
            ...
            $this->tag_sale_info->SetValue($this->DataSource->tag_sale_info->GetValue());
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["tag_sale_info"] = $this->tag_sale_info->Visible;
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->tag_sale_info->SetValue($items[$i]->tag_sale_info);
                        $this->tag_sale_info->Attributes->RestoreFromArray($items[$i]->_tag_sale_infoAttributes);
                    ...
                    case "Page":
                        if ($items[$i]->Mode == 1) {
                            ...
                            if ($this->Page_Header->Visible) {
                                ...
                                $this->Sorter_tag_sale_info->Show();
                                $Tpl->block_path = $ParentPath . "/" . $ReportBlock;
...
//DataSource Variables @3-9405B1ED
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    public $volume;
    public $money;
    public $tag_sale_info;
    public $TotalSum_volume;
    public $TotalSum_money;
//End DataSource Variables

//DataSourceClass_Initialize Event @3-AA820322
    function clsssf_addin_tags_sale_data1DataSource(& $Parent)
    {
        ...
        $this->tag_sale_info = new clsField("tag_sale_info", ccsText, "");
...
//SetOrder Method @3-F188270F
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "tag_sale_id desc";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_tag_sale_id" => array("tag_sale_id", ""), 
            "Sorter_tag_sale_tag_id" => array("tag_sale_tag_id", ""), 
            ...
            "Sorter_tag_sale_info" => array("tag_sale_info", "")));
    }
//End SetOrder Method

//Prepare Method @3-FD02CACB
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Open Method @3-F7AE45B9
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT end_date, end_time, pump_id, hose_id, grade_id, volume, money, tag_sale_tag_id, tag_sale_info, tag_sale_id,\n" .
        "config_values.id AS id\n" .
        "FROM (ssf_addin_tags_sale_data INNER JOIN ssf_pump_sales ON\n" .
        "ssf_addin_tags_sale_data.tag_sale_id = ssf_pump_sales.sale_id) INNER JOIN config_values\n" .
        "ON ssf_pump_sales.grade_id = config_values.param_value\n" .
        "WHERE tag_sale_tag_id LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'\n" .
...
//SetValues Method @3-7F0B2DDC
    function SetValues()
    {
        $this->tag_sale_id->SetDBValue(trim($this->f("tag_sale_id")));
        $this->tag_sale_tag_id->SetDBValue($this->f("tag_sale_tag_id"));
        ...
        $this->tag_sale_info->SetDBValue($this->f("tag_sale_info"));
